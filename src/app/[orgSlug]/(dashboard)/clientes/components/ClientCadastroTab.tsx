                  ...
                  {client?.phone && (
                    <div className="flex items-center gap-1">
                      ...
                      <Button 
                        ...
                        onClick={() => {
                          const num = client.phone.replace(/\D/g, '');
                          router.push(`${base}/whatsapp/chat?phone=${num}`);
                        }}
                      >
        ...
        <div className="space-y-4">
          <div className="p-4 bg-white dark:bg-slate-900 rounded-2xl border border-border/50">
            ...
            <div className="space-y-3">
              ...
              <div>
                <Label className="text-[10px] uppercase text-muted-foreground">Cód. Município IBGE</Label>
                <p className="text-sm font-semibold">{client?.cityCode || "Não informado"}</p>
              </div>
            </div>
          </div>
