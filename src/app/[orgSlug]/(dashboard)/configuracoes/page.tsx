    ...
    <div className="space-y-6 max-w-3xl animate-in">
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <Link href={`${base}/configuracoes/modulos`}>
          ...
          <Link href={`${base}/configuracoes/smtp`}>
            <Card className="hover:border-primary/50 transition-colors group">
              <CardHeader className="flex flex-row items-center gap-4">
                <div className="p-2 rounded-lg bg-primary/10 text-primary group-hover:bg-primary group-hover:text-white transition-colors">
          ...
          <Link href={`${base}/configuracoes/seguranca`}>
            <Card className="hover:border-primary/50 transition-colors group">
              <CardHeader className="flex flex-row items-center gap-4">
          ...
          <Link href={`${base}/configuracoes/nfe`}>
            <Card className="hover:border-primary/50 transition-colors group">
              <CardHeader className="flex flex-row items-center gap-4">
          ...
          {/* WhatsApp API */}
          <Link href={`${base}/configuracoes/whatsapp`}>
            <Card className="hover:border-primary/50 transition-colors group">
              <CardHeader className="flex flex-row items-center gap-4">
                <div className="p-2 rounded-lg bg-emerald-500/10 text-emerald-500 group-hover:bg-emerald-500 group-hover:text-white transition-colors">
          ...
          <Link href={`${base}/configuracoes/mcp`}>
            <Card className="hover:border-primary/50 transition-colors group">
              <CardHeader className="flex flex-row items-center gap-4">
          ...
          <Link href={`${base}/configuracoes/atualizacoes`}>
            <Card className="hover:border-primary/50 transition-colors group">
              <CardHeader className="flex flex-row items-center gap-4">
          ...
          <Link href={`${base}/configuracoes/pbx`}>
            <Card className="hover:border-primary/50 transition-colors group">
              <CardHeader className="flex flex-row items-center gap-4">
          ...
          <Link href={`${base}/configuracoes/pagamentos`}>
          ...
          {session?.user?.role === "master" && (
            <Link href={`${base}/configuracoes/whitelabel`}>
