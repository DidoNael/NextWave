...
/**
 * Altura do chat = 100vh ÔêÆ header(64px) ÔêÆ padding vertical do main por breakpoint:
 *   mobile  ÔåÆ p-4  = 16px íù 2 = 32px  ÔåÆ calc(100vh - 96px)
 *   md      ÔåÆ p-6  = 24px íù 2 = 48px  ÔåÆ calc(100vh - 112px)
 *   lg      ÔåÆ p-8  = 32px íù 2 = 64px  ÔåÆ calc(100vh - 128px)
 * Tailwind: usar underscore para espaíºos dentro de calc()
 */
const CHAT_HEIGHT =
...
function ChatPageContent() {
    ...
    return (
        <div className={cn(
            ...
            {/* Painel esquerdo ÔÇö lista de conversas */}
            <div className={cn(
            ...
            {/* Painel direito ÔÇö janela de conversa */}
            <div className={cn(
                ...
                {selectedChat ? (
                    ...
                    /* Estado vazio ÔÇö visível somente no desktop */
