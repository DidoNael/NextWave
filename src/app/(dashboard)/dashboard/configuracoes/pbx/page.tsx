...
export default function PbxSettingsPage() {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (res.ok) {
                toast.success("Configuraíºàes de PBX salvas com sucesso!");
            } else {
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Card className="md:col-span-1">
                    <CardHeader>
                        ...
                        <CardDescription>Escolha como o sistema faríí as ligaíºàes.</CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                        ...
                        <div className="p-4 rounded-lg bg-blue-500/5 border border-blue-500/10 space-y-2">
                            ...
                            <p className="text-[11px] text-muted-foreground leading-relaxed">
                                <strong>Twilio:</strong> Ideal para setup ríípido com númros virtuais.<br /><br />
                ...
                <Card className="md:col-span-2">
                    <CardHeader>
                        ...
                        <CardDescription>Preencha os dados tí®cnicos manualmente abaixo.</CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                        ...
                        {config.provider === "simulator" && (
                            <div className="py-12 flex flex-col items-center justify-center text-center space-y-3 opacity-50">
                                ...
                                <p className="text-sm">O modo simulador não requer credenciais externas.<br />Átil para treinamento da equipe.</p>
                            </div>
                        )}
