  ...
  return (
    <div className="space-y-6 max-w-5xl animate-in">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold">Versàes & Atualizaíºàes</h1>
          <p className="text-muted-foreground mt-1">Gerencie a versão do sistema e veja o histórico de mudaníºas</p>
        </div>
          ...
          <Card className="border-none shadow-xl bg-white/50 dark:bg-slate-900/50 backdrop-blur-sm">
            <CardHeader className="flex flex-row items-center gap-4">
              ...
              <div>
                ...
                <CardDescription>Histórico de atualizaíºàes e novas funcionalidades</CardDescription>
              </div>
            </CardHeader>
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            {i !== 0 && (
                              <Button
                                ...
                                onClick={async () => {
                                  if (!confirm(`Deseja restaurar o sistema para a versão ${v.version}? Isso iríí recompilar o sistema.`)) return;
            ...
            <CardContent className="p-4 pt-0 space-y-3">
              ...
              >
                <div className="flex items-center gap-3 text-left w-full">
                  ...
                  <div>
                    <p className="font-bold text-sm uppercase italic">­ƒÜÇ Atualização Completa</p>
              ...
              {[
                { id: 'pull', label: 'Buscar Atualizaíºàes', icon: RefreshCw, desc: 'Sincronizar com GitHub' },
                ...
                { id: 'reset', label: 'Resetar Alteraíºàes', icon: AlertCircle, desc: 'Limpar modificaíºàes locais' },
              ].map((btn) => (
                <Button 
                  key={btn.id}
                  variant="outline" 
