...
export default function McpSettingsPage() {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (res.ok) {
                toast.success("Configuraíºàes do MCP salvas com sucesso!");
            } else {
    ...
    return (
        <div className="space-y-6 max-w-4xl animate-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {/* Coluna Esquerda ÔÇö Informaíºàes */}
                <Card className="md:col-span-1">
                    <CardHeader>
                        <CardTitle className="text-lg">O que í® o MCP?</CardTitle>
                    ...
                    <CardContent className="space-y-4">
                        <div className="p-4 rounded-lg bg-blue-500/5 border border-blue-500/10 space-y-2">
                            ...
                            <p className="text-[11px] text-muted-foreground leading-relaxed">
                                O <strong>MCP Server</strong> expàe os dados do CRM (clientes, transaíºàes, projetos, agenda) como ferramentas e recursos para agentes de IA como Claude, ChatGPT e outros.
                            </p>
                            <p className="text-[11px] text-muted-foreground leading-relaxed">
                ...
                {/* Coluna Direita ÔÇö Configuraíºàes */}
                <Card className="md:col-span-2">
                    <CardHeader>
                        <CardTitle className="text-lg flex items-center gap-2">
                            <ShieldCheck className="h-5 w-5 text-emerald-500" />
                            Configuraíºàes de Seguraníºa
                        </CardTitle>
                    ...
                    <CardContent className="space-y-5">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                            <div className="space-y-2">
                                ...
                                />
                                <p className="text-[10px] text-muted-foreground">Requisiíºàes por janela</p>
                            </div>
                            <div className="space-y-2">
