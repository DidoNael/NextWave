    ...
    const handleVerifyToken = async () => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                toast.error("Código invíílido. Tente novamente.");
            }
        } catch (error) {
    ...
    return (
        <div className="max-w-2xl mx-auto space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="flex flex-col gap-2">
                <h1 className="text-3xl font-extrabold tracking-tight theme-title">Seguraníºa</h1>
                ...
                <CardHeader>
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <CardDescription>Adicione uma camada extra de seguraníºa usando um app autenticador.</CardDescription>
                        </div>
                    </div>
                </CardHeader>
                        ...
                        <div className="flex flex-col items-center gap-6 py-4 text-center">
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-sm text-muted-foreground max-w-sm">
                                    Ao ativar, você precisaríí de um código do seu celular toda vez que fizer login.
                                </p>
                            </div>
                        ...
                        <div className="space-y-6 py-4">
                            ...
                            <div className="p-3 bg-amber-500/10 border border-amber-500/20 rounded-lg flex gap-3 text-amber-600">
                                ...
                                <p className="text-[10px] leading-relaxed">
                                    Manual: {secret} <br />
                                    Guarde este código em local seguro. Se perder o celular, você precisaríí dele para recuperar o acesso.
                                </p>
                            </div>
                        </div>
                    )}
                    ...
                    {step === 3 && (
                        <div className="flex flex-col items-center gap-4 py-8 text-center text-success">
                            ...
                            <div className="space-y-1">
                                ...
                                <p className="text-sm text-muted-foreground">Sua conta agora estíí muito mais protegida.</p>
                            </div>
