...
export default function WhiteLabelPage() {
    ...
    const saveLicense = async () => {
        ...
        try {
            ...
            if (res.ok) toast.success("Liceníºa atualizada!");
        } catch (error) {
            toast.error("Erro ao salvar liceníºa.");
        } finally {
            setIsSaving(false);
        }
    };
        ...
        <div className="space-y-6 max-w-4xl animate-in">
            <div>
                <h1 className="text-2xl font-bold flex items-center gap-2">
                    ...
                    Configuraíºàes White-Label & Master
                </h1>
                <p className="text-muted-foreground mt-1">Gerenciamento exclusivo para revenda e controle de instíóncias.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <Card>
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <div className="space-y-2">
                            <Label>Email de Suporte (Píígina de Bloqueio)</Label>
                            <Input
                ...
                <Card className={license.status !== "active" ? "border-destructive/30" : ""}>
                    <CardHeader>
                        <CardTitle className="text-lg flex items-center gap-2">
                            <ShieldAlert className="h-5 w-5" /> Status da Liceníºa
                        </CardTitle>
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <div className="space-y-2">
                            <Label>Víílido Atí® (Apenas informativo por ora)</Label>
                            <Input
                                type="date"
                        ...
                        <div className="bg-muted/50 p-4 rounded-lg flex items-start gap-3">
                            ...
                            <p className="text-xs text-muted-foreground">
                                <strong>Importante:</strong> Mudar para "Suspenso" bloquearíí todas as telas do sistema para este cliente instantaneamente. Use para controle de falta de pagamento.
                            </p>
                        </div>
