...
export default function InfinitePaySettingsPage() {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (res.ok) {
                toast.success("Configuraíºàes da InfinitePay salvas!");
            } else {
        ...
        <div className="space-y-6 max-w-4xl animate-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Card className="md:col-span-1 border-purple-500/20 bg-purple-500/5">
                    <CardHeader>
                        <CardTitle className="text-lg">O que í® o Checkout?</CardTitle>
                    ...
                    <CardContent className="space-y-4">
                        <div className="flex items-start gap-3">
                            ...
                            <p className="text-xs text-muted-foreground leading-relaxed">
                                O Checkout Integrado permite criar links personalizados. Seus clientes pagam por Pix ou Cartão e o status í® atualizado aqui.
                            </p>
                        </div>
                        <div className="flex items-start gap-3">
                ...
                <Card className="md:col-span-2">
                    <CardHeader>
                        ...
                        <CardDescription>Insira sua InfiniteTag para comeíºar.</CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-6">
                        <div className="space-y-2">
                            ...
                            <p className="text-[10px] text-muted-foreground flex items-center gap-1">
                                <Info className="h-3 w-3" /> Sua InfiniteTag í® o nome que aparece no seu perfil da InfinitePay.
                            </p>
                        </div>
