...
import {
  ...
  Zap, Database, MessageSquare, Paintbrush, Clock, PieChart, Phone, Server, Key, Shield, Receipt, FileText, Mail,
  LogOut,
} from "lucide-react";
...
const bottomItemsBase = [
  ...
  { href: "/dashboard/configuracoes/smtp", label: "SMTP / E-mail", icon: Mail, masterOnly: false },
